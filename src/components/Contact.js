                                            ...
                                            <Dialog.Panel className="  w-full max-w-2xl transform overflow-hidden rounded-[20px] bg-white dark:bg-[#181123] p-12 text-left align-middle transition-all sm:py-16 sm:px-20 opacity-100 scale-100">
                                                ...
                                                <div className=" flex flex-col gap-8">
                                                    ...
                                                    <div className=" flex flex-col gap-2">
                                                        <p className=' italic leading-relaxed text-justify text-sm text-[#AAAEAE]'><span className=' text-[#9E6AF3] font-bold'>Work ethic?</span> Ultimately, you are solely responsible for your successes and failures. The sooner you realize it, accept it, and integrate it into your work ethic, the more successful you will begin to be. As long as you blame others for not being where you want to be, you will always fail.</p>
